...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Daftar Prestasi Siswa</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{ route('home') }}">Dashboard</a></li>
                    <li class="breadcrumb-item active">Daftar Prestasi Siswa</li>
                </ol>
            </div>
        </div>
    </div>
        ...
        <div class="card card-outline card-primary">
            <div class="card-header position-relative">
                <h3 class="card-title font-weight-bold">
                    <i class="fas fa-trophy mr-1"></i> Daftar Siswa dengan Prestasi
                </h3>
            ...
            <div class="card-body">
                <div class="search-section mb-3">
                    <div class="row">
                        <div class="col-md-8">
                            <form action="{{ route('achievements.all_students') }}" method="GET" class="form-inline">
                                ...
                                <a href="{{ route('achievements.all_students') }}" class="btn btn-secondary ml-2">Reset</a>
                            </form>
                        </div>
                ...
                <div class="table-responsive">
                    <table id="achievements-table" class="table table-bordered table-striped table-hover">
                        <thead>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">{{ $student->achievements_count }}</td>
                            ...
                            @empty
                            <tr>
                                <td colspan="7" class="text-center">Tidak ada data prestasi siswa.</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
...
<script>
    $(function() {
        $('#achievements-table').DataTable({
            ...
            "responsive": true,
            "language": {
                "emptyTable": "Tidak ada data prestasi siswa"
            },
            "columnDefs": [
