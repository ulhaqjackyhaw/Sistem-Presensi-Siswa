        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6 text-uppercase">
                    <h4 class="m-0">Tambah Kurikulum</h4>
                </div>
                <div class="col-sm-6">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-primary card-outline">
                        ...
                        <form action="{{ route('manage-curriculums.store') }}" method="post">
                            @csrf
                            <div class="card-body">
                                <div class="form-group">
                                    <label>Nama Kurikulum</label>
                                    <input type="text" name="curriculum_name"
                                        class="form-control @error('curriculum_name') is-invalid @enderror"
                                        placeholder="Contoh: Kurikulum Merdeka 2024" value="{{ old('curriculum_name') }}">
